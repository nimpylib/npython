...
proc clinicGenAuxHelper(hasSelf: bool, genedPureNameStr: string, def: NimNode, exported=true): tuple[name, params, body: NimNode] =
  let
...
proc clinicGenAux*(hasSelf: bool, genedPureNameStr: string, def: NimNode, exported=true): NimNode =
  let (name, nparams, body) = clinicGenAuxHelper(hasSelf, genedPureNameStr, def, exported)
...
proc clinicGenMethodOfKindImpl*(typ: NimNOde; kind: NPyMethodKind, exceptions, prc: NimNode, classmethod=false): NimNode =
  ...
  let hasSelf = kind == NPyMethodKind.Common
  ...
  let (methodName, args, body) = clinicGenAuxHelper(hasSelf, genedPureNameStr, prc, exported)
...
macro clinicGenMethod*(typ; prc) = clinicGenMethodOfKindImpl(typ, NPyMethodKind.Common, nnkBracket.newNimNode, prc)
macro clinicGenMethodRaises*(typ; exceptions; prc) = clinicGenMethodOfKindImpl(typ, NPyMethodKind.Common, exceptions, prc)
